"""
Implementing some commonly used loss functions

Given the neural network's output and the expected target values,
these functions compute the derivative of the respective loss functions
with respect to the output -> d(loss)/d(output)
"""
